    ...
    return(
        ...
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight">Start your journey with <span class="text-blue-600">Vistaraft</span></h1>
              <p class="mt-3 text-lg text-gray-800">Hand-picked professionals and expertly curated trips, for You.</p>
            ...
            <div class="relative ms-4">
              <img class="w-14/15 rounded-md" src={hero1} alt="Hero Image"/>
